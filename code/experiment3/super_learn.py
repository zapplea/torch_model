...
if __name__ =="__main__":
    ...
    for i in range(len(nn_configs)):
        ...
        if nn_config['is_share_weight']:
            nn_config['report_filePath']=nn_config['report_filePath']+'_share-super_proto_with_cnn.txt'
        else:
            nn_config['report_filePath']=nn_config['report_filePath']+'_super_proto_with_cnn.txt'
